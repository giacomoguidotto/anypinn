"""Heat Equation 1D — inverse PDE problem definition.

Solves: du/dt = alpha * d2u/dx2 on [0,1] x [0,1]
BCs: u(0,t) = u(1,t) = 0
IC: u(x,0) = sin(pi*x)
Analytic solution: u(x,t) = exp(-alpha pi^2 t) sin(pi x)

Inverse problem: recover alpha from sparse interior measurements.
"""
