...
def main(experiment_name: str, predict: bool = False) -> None:
    ...
    dm = create_data_module(hp, problem.fields, problem.params)

    if predict:
        module = PINNModule.load_from_checkpoint(model_path, problem=problem, weights_only=False)
    else:
    ...
    callbacks = [
        ...
        AdaptiveCollocationCallback(every_n_epochs=50),
    ]
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Allen-Cahn Equation Forward PDE Example")
